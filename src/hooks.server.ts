...
export const handle: Handle = async ({ event, resolve }) => {
	...
	response.headers.set('Content-Security-Policy', [
		...
		"connect-src 'self' api.groq.com accounts.google.com www.googleapis.com fonts.googleapis.com cloudflareinsights.com wss://signaling.yjs.dev wss://*.onrender.com wss://*.herokuapp.com",
