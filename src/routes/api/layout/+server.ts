...
4. Leave enough space between entities (minimum 150px gap)
5. For Chen notation: leave extra space (minimum 200px) because entities have attribute ovals around them
